...
void ReleaseNote2(int i){
	...
	switch (channel) {
		...
		case 0x02: brassList[i].released = 1; return;
	}
}
...
*************************************************/
// the Japanese scale
#pragma DATA_SECTION(JAPENESE , ".sdram");
unsigned char JAPANESE[55] = {0x37, //dec 55 -> size of array   Also called the Kuomi scale
...
#pragma DATA_SECTION(CHINESE , ".sdram");
...
#pragma DATA_SECTION(HARMONIC_MINOR , ".sdram");
...
unsigned char ARABIAN[76] = {0x4C,0x00,0x02,0x04,0x05,0x06,0x08,0x0A, //Octave -1
	                        0x0C,0x0E,0x10,0x11,0x12,0x14,0x16, //Octave  0 
	                        0x18,0x1A,0x1C,0x1D,0x1E,0x20,0x22, //Octave  1 
	                        0x24,0x26,0x28,0x29,0x2A,0x2C,0x2E, //Octave  2
	                        0x30,0x32,0x34,0x35,0x36,0x38,0x3A, //Octave  3 
	                        0x3C,0x3E,0x40,0x41,0x42,0x44,0x46, //Octave  4 
	                        0x48,0x4A,0x4C,0x4D,0x4E,0x50,0x52, //Octave  5
	                        0x54,0x56,0x58,0x59,0x5A,0x5C,0x5E, //Octave  6
	                        0x60,0x62,0x64,0x65,0x66,0x68,0x6A, //Octave  7
	                        0x6C,0x6E,0x70,0x71,0x72,0x74,0x76, //Octave  8
	                        0x78,0x7A,0x7C,0x7D,0x7E}; //Octave 9 


unsigned char BYZANTINE[76] = {0x4C,0x00,0x01,0x04,0x05,0x07,0x08,0x0B, //Octave -1
	                            0x0C,0x0D,0x10,0x11,0x13,0x14,0x17, //Octave  0 
	                            0x18,0x19,0x1C,0x1D,0x1F,0x20,0x23, //Octave  1 
	                            0x24,0x25,0x28,0x29,0x2B,0x2C,0x2F, //Octave  2
	                            0x30,0x31,0x34,0x35,0x37,0x38,0x3B, //Octave  3 
	                            0x3C,0x3D,0x40,0x41,0x43,0x44,0x47, //Octave  4 
	                            0x48,0x49,0x4C,0x4D,0x4F,0x50,0x53, //Octave  5
	                            0x54,0x55,0x58,0x59,0x5B,0x5C,0x5F, //Octave  6
	                            0x60,0x61,0x64,0x65,0x67,0x68,0x6B, //Octave  7
	                            0x6C,0x6D,0x70,0x71,0x73,0x74,0x77, //Octave  8
	                            0x78,0x79,0x7C,0x7D,0x7F }; //Octave 9 

unsigned char EGYPTIAN[55] = {0x37,0x00,0x02,0x05,0x07,0x0A, //Octave -1
	                             0x0C,0x0E,0x11,0x13,0x16, //Octave  0 
	                             0x18,0x1A,0x1D,0x1F,0x22, //Octave  1 
	                             0x24,0x26,0x29,0x2B,0x2E, //Octave  2
	                             0x30,0x32,0x35,0x37,0x3A, //Octave  3 
	                             0x3C,0x3E,0x41,0x43,0x46, //Octave  4 
	                             0x48,0x4A,0x4D,0x4F,0x52, //Octave  5
	                             0x54,0x56,0x59,0x5B,0x5E, //Octave  6
	                             0x60,0x62,0x65,0x67,0x6A, //Octave  7
	                             0x6C,0x6E,0x71,0x73,0x76, //Octave  8
	                             0x78,0x7A,0x7D,0x7F }; //Octave 

unsigned char ENIGMATIC[76] = {0x4C,0x00,0x01,0x04,0x06,0x08,0x0A,0x0B, //Octave -1
	                            0x0C,0x0D,0x10,0x12,0x14,0x16,0x17, //Octave  0 
	                            0x18,0x19,0x1C,0x1E,0x20,0x22,0x23, //Octave  1 
	                            0x24,0x25,0x28,0x2A,0x2C,0x2E,0x2F, //Octave  2
	                            0x30,0x31,0x34,0x36,0x38,0x3A,0x3B, //Octave  3 
	                            0x3C,0x3D,0x40,0x42,0x44,0x46,0x47, //Octave  4 
	                            0x48,0x49,0x4C,0x4E,0x50,0x52,0x53, //Octave  5
	                            0x54,0x55,0x58,0x5A,0x5C,0x5E,0x5F, //Octave  6
	                            0x60,0x61,0x64,0x66,0x68,0x6A,0x6B, //Octave  7
	                            0x6C,0x6D,0x70,0x72,0x74,0x76,0x77, //Octave  8
	                            0x78,0x79,0x7C,0x7E}; //Octave 9 



unsigned char GYPSY[76] = {0x4C,0x00,0x01,0x04,0x05,0x07,0x09,0x0A, //Octave -1
	                        0x0C,0x0D,0x10,0x11,0x13,0x15,0x16, //Octave  0 
	                        0x18,0x19,0x1C,0x1D,0x1F,0x21,0x22, //Octave  1 
	                        0x24,0x25,0x28,0x29,0x2B,0x2D,0x2E, //Octave  2
	                        0x30,0x31,0x34,0x35,0x37,0x39,0x3A, //Octave  3 
	                        0x3C,0x3D,0x40,0x41,0x43,0x45,0x46, //Octave  4 
	                        0x48,0x49,0x4C,0x4D,0x4F,0x51,0x52, //Octave  5
                            0x54,0x55,0x58,0x59,0x5B,0x5D,0x5E, //Octave  6	                                  
                            0x60,0x61,0x64,0x65,0x67,0x69,0x6A, //Octave  7
	                        0x6C,0x6D,0x70,0x71,0x73,0x75,0x76, //Octave  8
	                        0x78,0x79,0x7C,0x7D,0x7F }; //Octave 
							
unsigned char HIRAJOSHI[55] = {0x37, //dec 55 -> size of array
	0x00,0x02,0x03,0x07,0x08, //Octave -1
	0x0C,0x0E,0x0F,0x13,0x14, //Octave 0
	0x18,0x1A,0x1B,0x1F,0x20, //Octave 1
	0x24,0x26,0x27,0x2B,0x2C, //Octave 2
	0x30,0x32,0x33,0x37,0x38, //Octave 3
	0x3C,0x3E,0x3F,0x43,0x44, //Octave 4
	0x48,0x4A,0x4B,0x4F,0x50, //Octave 5
	0x54,0x56,0x57,0x5B,0x5C, //Octave 6
	0x60,0x62,0x63,0x67,0x68, //Octave 7
	0x6C,0x6E,0x6F,0x73,0x74, //Octave 8
	0x78,0x7A,0x7B,0x7F}; //Octave 9 

unsigned char JEWISH[76] = {0x4C,   0x00,0x01,0x04,0x05,0x07,0x08,0x0A, //Octave -1
	                            0x0C,0x0D,0x10,0x11,0x13,0x14,0x16, //Octave  0 
	                            0x18,0x19,0x1C,0x1D,0x1F,0x20,0x22, //Octave  1 
	                            0x24,0x25,0x28,0x29,0x2B,0x2C,0x2E, //Octave  2
	                            0x30,0x31,0x34,0x35,0x37,0x38,0x3A, //Octave  3 
	                            0x3C,0x3D,0x40,0x41,0x43,0x44,0x46, //Octave  4 
	                            0x48,0x49,0x4C,0x4D,0x4F,0x50,0x52, //Octave  5
	                            0x54,0x55,0x58,0x59,0x5B,0x5C,0x5E, //Octave  6
	                            0x60,0x61,0x64,0x65,0x67,0x68,0x6A, //Octave  7
	                            0x6C,0x6D,0x70,0x71,0x73,0x74,0x76, //Octave  8
	                            0x78,0x79,0x7C,0x7D,0x7F }; //Octave 9 


unsigned char HINDU[76] = {0x4C,    0x00,0x02,0x04,0x05,0x07,0x08,0x0A, //Octave -1
	                            0x0C,0x0E,0x10,0x11,0x13,0x14,0x16, //Octave  0 
	                            0x18,0x1A,0x1C,0x1D,0x1F,0x20,0x22, //Octave  1 
	                            0x24,0x26,0x28,0x29,0x2B,0x2C,0x2E, //Octave  2
	                            0x30,0x32,0x34,0x35,0x37,0x38,0x3A, //Octave  3 
	                            0x3C,0x3E,0x40,0x41,0x43,0x44,0x46, //Octave  4 
	                            0x48,0x4A,0x4C,0x4D,0x4F,0x50,0x52, //Octave  5
	                            0x54,0x56,0x58,0x59,0x5B,0x5C,0x5E, //Octave  6
	                            0x60,0x62,0x64,0x65,0x67,0x68,0x6A, //Octave  7
	                            0x6C,0x6E,0x70,0x71,0x73,0x74,0x76, //Octave  8
	                            0x78,0x7A,0x7C,0x7D,0x7F }; //Octave 9 


unsigned char ALGERIAN[76] = {0x4C,0x00,0x02,0x03,0x06,0x07,0x08,0x0B, //Octave -1
	                           0x0C,0x0E,0x0F,0x12,0x13,0x14,0x17, //Octave  0 
	                           0x18,0x1A,0x1B,0x1E,0x1F,0x20,0x23, //Octave  1 
	                           0x24,0x26,0x27,0x2A,0x2B,0x2C,0x2F, //Octave  2
	                           0x30,0x32,0x33,0x36,0x37,0x38,0x3B, //Octave  3
	                           0x3C,0x3E,0x3F,0x42,0x43,0x44,0x47, //Octave  4 	                            

                                   0x48,0x4A,0x4B,0x4E,0x4F,0x50,0x53, //Octave  5
                                   0x54,0x56,0x57,0x5A,0x5B,0x5C,0x5F, //Octave  6
	                           0x60,0x62,0x63,0x66,0x67,0x68,0x6B, //Octave  7
	                           0x6C,0x6E,0x6F,0x72,0x73,0x74,0x77, //Octave  8
	                           0x78,0x7A,0x7B,0x7E,0x7F }; //Octave 9 

unsigned char BALINESE[55] = {0x37,0x00,0x01,0x03,0x07,0x08, //Octave -1
	                           0x0C,0x0D,0x0F,0x13,0x14, //Octave  0 
	                           0x18,0x19,0x1B,0x1F,0x20, //Octave  1 
	                           0x24,0x25,0x27,0x2B,0x2C, //Octave  2
	                           0x30,0x31,0x33,0x37,0x38, //Octave  3 
	                           0x3C,0x3D,0x3F,0x43,0x44, //Octave  4 
	                           0x48,0x49,0x4B,0x4F,0x50, //Octave  5
	                           0x54,0x55,0x57,0x5B,0x5C, //Octave  6
	                           0x60,0x61,0x63,0x67,0x68, //Octave  7
	                           0x6C,0x6D,0x6F,0x73,0x74, //Octave  8
	                           0x78,0x79,0x7B,0x7F }; //Octave 9 

unsigned char SPANISH[76] = {0x4C,0x00,0x01,0x04,0x05,0x07,0x08,0x0A, //Octave -1
	                          0x0C,0x0D,0x10,0x11,0x13,0x14,0x16, //Octave  0 
	                          0x18,0x19,0x1C,0x1D,0x1F,0x20,0x22, //Octave  1 
	                          0x24,0x25,0x28,0x29,0x2B,0x2C,0x2E, //Octave  2
	                          0x30,0x31,0x34,0x35,0x37,0x38,0x3A, //Octave  3 
...
unsigned char HUNGARIANGYPSY[76] = {0x4C,0x00,0x02,0x03,0x06,0x07,0x08,0x0A, //Octave -1
	                                 0x0C,0x0E,0x0F,0x12,0x13,0x14,0x16, //Octave  0 
	                                 0x18,0x1A,0x1B,0x1E,0x1F,0x20,0x22, //Octave  1 
	                                 0x24,0x26,0x27,0x2A,0x2B,0x2C,0x2E, //Octave  2
	                                 0x30,0x32,0x33,0x36,0x37,0x38,0x3A, //Octave  3 
	                                 0x3C,0x3E,0x3F,0x42,0x43,0x44,0x46, //Octave  4 
	                                 0x48,0x4A,0x4B,0x4E,0x4F,0x50,0x52, //Octave  5
	                                 0x54,0x56,0x57,0x5A,0x5B,0x5C,0x5E, //Octave  6
	                                 0x60,0x62,0x63,0x66,0x67,0x68,0x6A, //Octave  7
	                                 0x6C,0x6E,0x6F,0x72,0x73,0x74,0x76, //Octave  8
	                                 0x78,0x7A,0x7B,0x7E,0x7F }; //Octave 9 
...
void ScaleHarmonizer(MIDIEvent *event){
	...
	harmonizerScales[4] = ARABIAN;
	harmonizerScales[5] = BYZANTINE;
	harmonizerScales[6] = EGYPTIAN;
	harmonizerScales[7] = ENIGMATIC;
	harmonizerScales[8] = GYPSY;
	harmonizerScales[9] = HIRAJOSHI;
	harmonizerScales[10] = JEWISH;
	harmonizerScales[11] = HINDU;
	harmonizerScales[12] = ALGERIAN;
	harmonizerScales[13] = BALINESE;
	harmonizerScales[14] = SPANISH;
	harmonizerScales[15] = HUNGARIANGYPSY;
